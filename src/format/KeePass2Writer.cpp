...
void KeePass2Writer::writeDatabase(QIODevice* device, Database* db)
{
    ...
    QByteArray encryptionIV = randomGen()->randomArray(8);
    QByteArray protectedStreamKey = randomGen()->randomArray(8);
    ...
    SymmetricCipherStream cipherStream(device, SymmetricCipher::Des, SymmetricCipher::Cbc,
